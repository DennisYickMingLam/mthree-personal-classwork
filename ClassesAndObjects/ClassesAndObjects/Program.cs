...
namespace ClassesAndObjects
{
    ...
    public class Order
    {
        ...
        //Note:  auto-implemented properties declare a private instance backing field
        //if we want to make our setter readonly,  we need to make our set, private
    ...
    {    
        ...
        {
            //Comment this out to see if this is redundant
            _level = startingLevel;
        }
    }
